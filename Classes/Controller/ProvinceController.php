 ...
 *
 */
class ProvinceController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {

	/**
	 * provinceRepository
	 *
	 * @var \SUB\Buechertransport\Domain\Repository\ProvinceRepository
	 * @inject
	 */
	 ...
	 * action show
	 *
	 * @param \SUB\Buechertransport\Domain\Model\Province $province
	 * @dontvalidate $province
	 * @return void
	 */
	public function showAction(\SUB\Buechertransport\Domain\Model\Province $province) {
	 ...
	 * @return void
	 */
	public function showReachablesAction(\SUB\Buechertransport\Domain\Model\Province $province) {
		$this->view->assign('province', $province);
	}
	 ...
	 * @return void
	 */
	public function showMapAction(\SUB\Buechertransport\Domain\Model\Province $province) {
		$this->view->assign('province', $province);
	}
	 ...
	 * action new
	 *
	 * @param \SUB\Buechertransport\Domain\Model\Province $newProvince
	 * @dontvalidate $newProvince
	 * @return void
	 */
	public function newAction(\SUB\Buechertransport\Domain\Model\Province $newProvince = NULL) {
	 ...
	 * @return void
	 */
	public function createAction(\SUB\Buechertransport\Domain\Model\Province $newProvince) {
	 ...
	 * @return void
	 */
	public function editAction(\SUB\Buechertransport\Domain\Model\Province $province) {
		$this->view->assign('province', $province);
	}
	 ...
	 * @return void
	 */
	public function updateAction(\SUB\Buechertransport\Domain\Model\Province $province) {
	 ...
	 * @return void
	 */
	public function deleteAction(\SUB\Buechertransport\Domain\Model\Province $province) {
