...
/**
 * Test case for class Tx_Buechertransport_Controller_LibraryController.
 *
 * @version $Id$
 ...
 */
class Tx_Buechertransport_Controller_LibraryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
