...
/**
 * Test case for class Tx_Buechertransport_Controller_ProvinceController.
 *
 * @version $Id$
 ...
 */
class Tx_Buechertransport_Controller_ProvinceControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
