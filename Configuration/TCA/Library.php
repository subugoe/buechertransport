...
$TCA['tx_buechertransport_domain_model_library'] = array(
	...
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, sigel, distributioncentre,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:buechertransport/Resources/Private/Language/locallang_db.xlf:tx_buechertransport_domain_model_library.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'sigel' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:buechertransport/Resources/Private/Language/locallang_db.xlf:tx_buechertransport_domain_model_library.sigel',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
